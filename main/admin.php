...
if ($user_table_page < 1)
    $user_table_page = 1;
if ($review_table_page < 1)
    $review_table_page = 1;
if ($rent_table_page < 1)
    $rent_table_page = 1;
if ($product_table_page < 1)
    $product_table_page = 1;
    ...
    <div class="container">
        ...
        <div class="pagination">
            <?php if ($users_data['page'] > 1): ?>
                <a class="button"
                    href="?user_table_page=1<?= (isset($_GET['product_product']) ? '&product_product=' . urlencode($_GET['product_product']) : '') ?>">Первая</a>
