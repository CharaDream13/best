    ...
    <div class="container">
        <div class="container_flex">
            ...
            <form method="POST" action="">
                ...
                <?php endif; ?>
                <p>Стоимость аренды зависит от цены и длительности аренды, но также есть скидка, зависящая от длительности</p>
                <p>от 3 до 4 часов скидка 5%</p>
                <p>от 5 до 6 часов скидка 10%</p>
                <p>от 7 до 8 часов скидка 15%</p>
                <p>от 9 часов и более скидка 20%</p>
                <input type="number" id="duration" name="duration" placeholder="Укажите длительность аренды (в часах)" required>
                ...
                <h2>Итоговая стоимость: <span id="final-price"><?= number_format($price, 2, '.', '') ?></span> ₽</h2>
